...
{
    public partial class NetworkClient : GodotObject
    {
    ...
    // Data structures
    public partial class MessageEnvelope : GodotObject
    {
    ...
    public partial class ChangeBatch : GodotObject
    {
        public List<object> Changes { get; set; } = new List<object>();
    }

    public partial class PropertyChange : GodotObject
    {
    ...
    public partial class AddNodeChange : GodotObject
    {
        [JsonPropertyName("type")]
        public string Type { get; set; }
    ...
    public partial class RemoveNodeChange : GodotObject
    {
        [JsonPropertyName("type")]
        public string Type { get; set; }
    ...
    public partial class PresenceMessage : GodotObject
    {
        [JsonPropertyName("type")]
        public string Type { get; set; }
